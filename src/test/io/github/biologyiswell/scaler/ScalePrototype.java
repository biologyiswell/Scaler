...
public class ScalePrototype {
    ...
    public static void main(String[] args) {
        Engineer engineer = Engineer.builder().name("Foo").age(20).city("São Paulo").phone("000 0001").address("St. View 1").build();
        DataTypeVariable variables = new DataTypeVariable();

        // @Note For-each loop from the all declared fields that contains in the Engineer class.
        // for (Field field : engineer.getClass().getDeclaredFields()) {

        // @Note For-each loop from the all declared fields that contains in the DataTypeVariable class.
//        for (Field field : DataTypeVariable.class.getDeclaredFields()) {
//            System.out.println("Field Name: " + field.getName());
//            System.out.println("Field Type: " + field.getType().toString());
//            System.out.println("Field Annotated Type: " + field.getAnnotatedType());
//            System.out.println("Field Generic Type: " + field.getGenericType());
//            System.out.println("-----");
//        }

        ScalePrototype scalePrototype = new ScalePrototype();

        // System.out.println(scalePrototype.scaleObject(engineer));
        // System.out.println(scalePrototype.scaleObject(variables));
        System.out.println(scalePrototype.scaleObject(new ArrayVariable()));
    }
